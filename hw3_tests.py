...
class TestCases(unittest.TestCase):
    ...
    def test_filter_by_state_1(self):
        ...
        input2 = 'CA'
        expected = 58
        actual = len(hw3.filter_by_state(input1, input2))
        self.assertEqual(expected, actual)
...
#test population_by_ethnicity
    def test_population_by_ethnicity_1(self):
        ...
        input2 = "lajfgh;asff"
        expected = 0
        actual = hw3.population_by_ethnicity(input1, input2)
        self.assertEqual(expected, actual)
...
#test population_below_poverty_level
    def test_population_below_poverty_level_1(self):
        ...
        actual = hw3.population_below_poverty_level(input1)
        self.assertEqual(expected, actual)
    ...
    def test_percent_by_ethnicity_1(self):
        ...
        input2 = "lajfgh;asff"
        expected = 0
        actual = hw3.percent_by_ethnicity(input1, input2)
        self.assertEqual(expected, actual)

    def test_percent_by_ethnicity_2(self):
        input1 = reduced_data
        input2 = "Two or More Races"
        expected = 0.036007141
        actual = hw3.percent_by_ethnicity(input1, input2)
        self.assertAlmostEqual(expected, actual)
    ...
    def test_percent_below_poverty_level_1(self):
        input1 = build_data.get_data()
        expected = 0.153662864
        actual = hw3.percent_below_poverty_level(input1)
        self.assertAlmostEqual(expected, actual)

    def test_percent_below_poverty_level_2(self):
        input1 = reduced_data
        expected = 0.164241504819
        actual = hw3.percent_below_poverty_level(input1)
        self.assertAlmostEqual(expected, actual)
    ...
    def test_education_less_than_1(self):
        ...
        input3 = 0.03221
        expected = []
        actual = hw3.education_less_than(input1, input2,input3)
        self.assertEqual(expected, actual)
    ...
    def test_ethnicity_greater_than_1(self):
        ...
        input3 = 0.03221
        expected = []
        actual = hw3.ethnicity_greater_than(input1, input2, input3)
        self.assertEqual(expected, actual)

    def test_ethnicity_greater_than_2(self):
        input1 = reduced_data
        input2 = "Hispanic or Latino"
        input3 = 30.0 #in percents
        expected = [
    data.CountyDemographics(
        {'Percent 65 and Older': 11.5,
         'Percent Under 18 Years': 21.7,
    ...
    def test_ethnicity_less_than_1(self):
        ...
        input3 = 0.03221
        expected = []
        actual = hw3.ethnicity_less_than(input1, input2, input3)
        self.assertEqual(expected, actual)
    ...
    def test_below_poverty_level_greater_than_1(self):
        input1 = build_data.get_data()
        input2 = 0
        expected = build_data.get_data()
        actual = hw3.below_poverty_level_greater_than(input1, input2)
        self.assertEqual(expected, actual)
    ...
    def test_below_poverty_level_less_than_1(self):
        ...
        input2 = 0
        expected = []
        actual = hw3.below_poverty_level_less_than(input1, input2)
        self.assertEqual(expected, actual)
